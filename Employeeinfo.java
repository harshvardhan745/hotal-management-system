...
public class Employeeinfo extends JFrame implements ActionListener{
    ...
    Employeeinfo(){
        t1=new JTable();
        t1.setBounds(5,50,775,400);
        add(t1);

        JLabel l1=new JLabel("Name");
        l1.setBounds(35,10,70,20);
        add(l1);

        JLabel l2=new JLabel("Age");
        l2.setBounds(113,10,70,20);
        add(l2);
